...
view: inventory_pdt {
  derived_table: {
    ...
    sql:
      ...
      SUM(CASE WHEN "currency_change_magic_wand_change_amount">0 and "currency_change_magic_wand_amount_type" = 'CountBased' THEN "currency_change_magic_wand_change_amount" END) AS "magic_wand_gain",
      ...
      SUM(CASE WHEN "currency_change_life_change_amount">0 and "currency_change_life_amount_type" = 'CountBased' THEN "currency_change_life_change_amount" END) AS "life_gain",
      ...
      SUM(CASE WHEN "currency_change_glove_change_amount">0 and "currency_change_glove_amount_type" = 'CountBased' THEN "currency_change_glove_change_amount" END) AS "glove_gain",
      ...
      SUM(CASE WHEN "currency_change_extra_time_change_amount">0 and "currency_change_extra_time_amount_type" = 'CountBased' THEN "currency_change_extra_time_change_amount" END) AS "extra_time_gain",
      ...
      SUM(CASE WHEN "currency_change_extra_slot_change_amount">0 and "currency_change_extra_slot_amount_type" = 'CountBased' THEN "currency_change_extra_slot_change_amount" END) AS "extra_slot_gain",
      ...
      SUM(CASE WHEN "currency_change_environment_token_change_amount">0 and "currency_change_environment_token_amount_type" = 'CountBased' THEN "currency_change_environment_token_change_amount" END) AS "environment_token_gain",
      ...
      SUM(CASE WHEN "currency_change_coin_change_amount">0 and "currency_change_coin_amount_type" = 'CountBased' THEN "currency_change_coin_change_amount" END) AS "coin_gain",
      ...
      SUM(CASE WHEN "currency_change_magnet_change_amount">0 and "currency_change_magnet_amount_type" = 'CountBased' THEN "currency_change_magnet_change_amount" END) AS "magnet_gain",
      ...
      SUM(CASE WHEN "currency_change_shuffle_change_amount">0 and "currency_change_shuffle_amount_type" = 'CountBased' THEN "currency_change_shuffle_change_amount" END) AS "shuffle_gain",
      ...
      SUM(CASE WHEN "currency_change_time_freezer_change_amount">0 and "currency_change_time_freezer_amount_type" = 'CountBased' THEN "currency_change_time_freezer_change_amount" END) AS "time_freezer_gain",
      ...
      SUM(CASE WHEN "currency_change_toss_change_amount">0 and "currency_change_toss_amount_type" = 'CountBased' THEN "currency_change_toss_change_amount" END) AS "toss_gain",
      ...
      AND "eventque_business"."source" not in ('InAppPurchase','RewardedAdComplete','CoinRush')
      ) "dsg"
